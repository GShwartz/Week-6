...
<img src="https://i.postimg.cc/DfgyTrs9/staging-vnet-topology.jpg"> <br />
...
| [azurerm_resource_group.staging_rg](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/resource_group) | resource |
...
| [azurerm_virtual_machine.webapp](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/virtual_machine) | resource |
...
| <a name="input_counter"></a> [counter](#input\_counter) | How many VMs? | `number` | `2` | no |
| <a name="input_db_dns_zone_name"></a> [db\_dns\_zone\_name](#input\_db\_dns\_zone\_name) | DNS Name for Flexible server | `string` | `"Database"` | no |
...
| <a name="input_rg_name"></a> [rg\_name](#input\_rg\_name) | Resource Group Name | `string` | `"Staging"` | no |
| <a name="input_virtual_network_name"></a> [virtual\_network\_name](#input\_virtual\_network\_name) | Name for the Virtual Network | `string` | `"Virtual_Network"` | no |
...
| <a name="output_webservers_admin_password"></a> [webservers\_admin\_password](#output\_webservers\_admin\_password) | n/a |
<!-- END_TF_DOCS -->

# Estimated Costs
<img src="https://i.postimg.cc/ZqTfMRHb/staging-costs.jpg"> <br />
